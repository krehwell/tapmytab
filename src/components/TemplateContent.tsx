        ...
        <>
            <header>
                ...
                <p>
                    ...
                    classes in silicon, but you could use silicon purely with no classes, just tags such as{' '}
                    <code>&lt;table&gt;</code>. Fonts are also included in the CSS file, so you don't need to link any.
                </p>
            </header>
            <section id='vp-widths'>
                ...
                <p className='card'>
                    ...
                    There are <u>5 page layouts</u>, <code>&lt;div class='width-xs'&gt;</code>,{' '}
                    <code>&lt;div class='width-s'&gt;</code>, <code>&lt;div class='width-m'&gt;</code>,{' '}
                    <code>&lt;div class='width-l'&gt;</code>, and <code>&lt;div class='width-xl'&gt;</code>
                    they each take up 20%, 30%, 50%, 80%, and 100% of the screen respectively on at least
                    <code>1920x1080</code> and slightly more on smaller displays, by default the{' '}
                    <code>&lt;body&gt;</code>{' '}
                    will use 30% of the screen, these classes will up a portion of the actual screen/viewport. it should
                    be noted that all 3 of these viewport classes use 90% of the screen on mobiles.
                </p>
            </section>
            ...
            <main>
                ...
                <h4>Code</h4>
                <p>
                    <code>print('hello world')</code> you might want to embed a snippet of code. You can also use{' '}
                    <code>&lt;code&gt;</code> inside a <code>&lt;pre&gt;</code>{' '}
                    to get a code snippet spanning multiple lines.
                </p>
                <pre>
                ...
                <p>
                    Here is an <ins>ins</ins> tag, here is a <del>del</del> tag, and here is a <mark>mark</mark> tag
                </p>
                <h2>Lists</h2>
                ...
                <div>
                    ...
                    <ul>
                        <li>
                            ...
                            creates a focal point with uppercase text and center alignment.
                        </li>
                        <ul>
                            <li>
                                <code>&lt;* class='notice warning'&gt;</code>{' '}
                                creates a danger/red card with otherwise same styling as a normal <code>notice</code>.
                            </li>
                        </ul>
                    </ul>
                    <h3>Flexbox</h3>
                    <ul>
                        <li>
                            ...
                            makes any element a flexbox with vertical and horizontal center alignment{' '}
                            <strong>in a row</strong>.
                        </li>
                        <ul>
                            <li>
                                <code>&lt;* class='flex column'&gt;</code> vertical and horizontal alignment{' '}
                                <strong>in a column</strong>.
                            </li>
                            <li>
                                <code>&lt;* class='flex wrap'&gt;</code> applies flex wrap to the element.
                            </li>
                        </ul>
                    </ul>
                    <h3>Grids</h3>
                    <ul>
                        ...
                        <li>
                            <code>&lt;div class='grid gap'&gt;</code> adds the standard gap to the grid.
                        </li>
                        <ul>
                            <li>
                                <code>
                                    &lt;div class='grid'&gt; &lt;* class='span c-2 / 3 / 4 / 5'&gt;&lt;/*&gt;
                                    &lt;/div&gt;
                                </code>{' '}
                                creates a grid item that spans multiple columns, going from 2 to 5.
                            </li>
                            <li>
                                <code>
                                    &lt;div class='grid'&gt; &lt;* class='span r-2 / 3 / 4 / 5'&gt;&lt;/*&gt;
                                    &lt;/div&gt;
                                </code>{' '}
                    ...
                    <ul>
                        ...
                        <li>
                            <code>&lt;* class='width-100'&gt;</code> 100% <strong>parent</strong> width
                        </li>
                        <li>
                            <code>&lt;* class='height-100'&gt;</code> 100% <strong>parent</strong> height
                        </li>
                        <li>
                            <code>&lt;* class='fullscreen'&gt;</code> 100% of the entire viewport (width and height)
                        </li>
                    </ul>
                </div>
            </article>
